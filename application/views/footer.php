    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="<?php base_url('public') ?> /login.html">Logout</a>
            </div>
        </div>
    </div>
</div>
...
<!-- Page level plugins -->
<script src="<?php base_url('public') ?>/vendor/chart.js/Chart.min.js"></script>

<!-- Page level custom scripts -->
<script src="<?php base_url('public') ?>/js/demo/chart-area-demo.js"></script>
<script src="<?php base_url('public') ?>/js/demo/chart-pie-demo.js"></script>
